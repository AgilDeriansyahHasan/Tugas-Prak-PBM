...
// Kelas untuk merepresentasikan data item dengan field price baru
class Item {
  final int id;
  final String name;
  final double price; // field baru
...
class _MyAppState extends State<MyApp> {
  ...
  // Daftar item contoh dengan harga
  final List<Item> _items = [
    Item(id: 1, name: 'Item 1', price: 10000),
    Item(id: 2, name: 'Item 2', price: 20000),
    Item(id: 3, name: 'Item 3', price: 30000),
  ];
