...
class _SetupFlowScreenState extends State<SetupFlowScreen> {
  ...
  void _onConnected() {
    _navigatorKey.currentState!.pushNamed('device_settings');
  }
        ...
        onGenerateRoute: (settings) {
          ...
          switch (settings.name) {
            case 'find_devices':
              ...
              break;
            case 'connect_device':
              page = ConnectDeviceScreen(onSetupComplete: _onConnected);
              break;
            case 'device_settings':
              page = DeviceSettingsScreen(
                onFinish: () => _completeSetup(context),
              );
              break;
            default:
              page = FindDevicesScreen(onDeviceFound: _onDeviceFound);
...
// Layar Pengaturan Perangkat (DeviceSettingsScreen)
class DeviceSettingsScreen extends StatelessWidget {
  final VoidCallback onFinish;

  const DeviceSettingsScreen({super.key, required this.onFinish});
